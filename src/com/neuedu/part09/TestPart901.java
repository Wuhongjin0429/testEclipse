 ...
 * 
 * 面试：1.了解http/https区别？   2.TCP/IP协议特点
 * 
 * 2.Object 所有类的父类 
 ...
 * 其中还含有自动装箱和拆箱的概念
 * 
 * 字符串和包装类的转换：包装类转字符串 调用对应的toString(),
 * 字符串转包装类2种方法 ：1.都可以调用包装类的构造器转换 
...
public class TestPart901 {
	...
	public static void main(String[] args) {
        ...
        String strInt = boolean1.toString();//包装类转换成字符串
        System.out.println(strInt);
        
        Boolean valueOf = Boolean.valueOf(str);//字符串转换成包装类
        System.out.println(valueOf);
        
        try{
        	 int parseInt = Integer.parseInt(str);//包装类转换成基本数据类型
